...
document.getElementById("sign-in").addEventListener('click', function () {
  ...
  var request = new Request("".concat(server, "/signin"), {
    method: 'POST',
    body: body
  });
  fetch(request, {
...
document.getElementById("verify").addEventListener('click', function () {
  ...
  var request = new Request("".concat(server, "/verify"), {
    method: 'POST',
    body: body
  });
  fetch(request, {
    ...
    var verify = _ref4.verify;
    var status = verify ? 'Passed' : 'Failed';
    if (verify) amtBtn.style.display = "block";
    alert("Verification ".concat(status));
  });
});
